...
const Notification = () => {
    ...
    return (
        <div className={`p-2 text-gray-900 text-sm absolute font-semibold bg-blue-300 bottom-2 left-1 rounded-lg shadow-xl flex items-center z-50 transition duration-200 ${hasNewDeploy ? "translate-x-0" : "-translate-x-56"}`}>
